...
class LocalAttention(nn.Module):  # 定义局部注意力类，继承 nn.Module
    def __init__(self, embed_size, num_heads, window_size):  # 构造函数，初始化嵌入维度、头数和窗口大小
        super(LocalAttention, self).__init__()  # 调用父类构造函数
